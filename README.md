# Rozetka ↔ KeyCRM Debug UI

Мінімальний сервіс на Express зі статичним фронтендом для перегляду, зіставлення та синхронізації замовлень між Rozetka і KeyCRM. Усі дії виконуються через вебінтерфейс і REST-ендпоїнти, додаткові CLI-скрипти видалені.
